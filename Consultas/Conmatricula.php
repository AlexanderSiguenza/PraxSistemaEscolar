<?php
   ...
   while ($i < $n){
    ...
    $seccion2= $seccion[$c-1];
    $grado2=$grado[$c-1];
   //echo(" $grado2  /   Seccion: $seccion2.....$codigo1");
?>
...
<div id="content">
  <h1 align="center">&nbsp;</h1>
  <h1 align="left"><img src="../CSS/ico/Search.png" alt="" width="64" height="64" />Alumnos: <?php echo(" $grado2  /   Seccion: $seccion2");?></h1>
  <div align="center">
    <?
