<?
  ...
  function agregar_departamento($_Nombre){
  ...
  function eliminar_departamento($_Nombre){
      require_once('../Config/c_conexion.php');
      $link= Conectarse();
    ...
    function modificar_departamento($_Nombre){
    require_once('../Config/c_conexion.php');
    $link= Conectarse();
    ...
    function buscar_departamento($_Nombre){
        require_once('../Config/c_conexion.php');
        $link=Conectarse();
    ...
    function  mostrar_departamento(){
     ...
     function  combobox_departamento(){
        require_once('../Config/c_conexion.php');
        $link=Conectarse();
