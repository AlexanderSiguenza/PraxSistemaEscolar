...
$queEmp = "SELECT Nombres,CONCAT(Apellido1 ,' ', Apellido2) as Apellido,FechaNacimiento,
        Direccion,Departamento_codigoDepto,Municipio_codigoMunicipio,
        Telefono,Sexo,Discapacidad,ProblemasdeSalud,Estado,
        Usuario_nombreUsuario as Usuario
        FROM alumno,matricula
        where matricula.Seccion_codigoSeccion=$codigo and CodigoAlumno = matricula.Alumno_codigoAlumno";
...
$titles = array(
                ...
                //'Sexo'=>'<b>Sexo</b>',
                //'Discapacidad'=>'<b>Discapacidad</b>',
               // 'ProblemasdeSalud'=>'<b>ProblemasdeSalud</b>',
                'Usuario'=>'<b>Usuario</b>',
                'Estado'=>'<b>Estado</b>'
            );
$options = array(
