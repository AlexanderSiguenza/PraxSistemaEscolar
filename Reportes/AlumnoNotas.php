...
$result= mysql_query($periodo,$conexion)or die("Problemas en la instrucción select:".mysql_error());
$row = mysql_fetch_array($result);
...
$pdf->ezText($txttit1, 15, array('justification'=>'center'));
$pdf->ezText($txttit, 12);
$pdf->ezTable($data,$titles,'', $options);
$pdf->ezText("\n\n\n\n\n", 10);
$pdf->ezText("<b>Firma:_____________________                              Sello:</b>",11);
$pdf->ezText("<b>                      Profesor       </b>",11);
$pdf->ezText("\n", 10);
