...
<div id="content">
  <div align="center">
   ...
   if ($_POST ['Nombre']==NULL){
       ...
       $logueado=$a->modificar_seccion($_POST ['Codigo'],$_POST ['Nombre'],$_POST ['Grado'],$_POST ['Docente']);
}
?>
  <?if ($logueado ==2){?>
  ...
  <? echo("El Seccion se Modifico con Exito....."."<br>"); }?>

   <?if ($logueado ==3){ ?>
    <p align="left"><img src="../CSS/ico/Edit_No.png" alt="" width="64" height="61"  />
  <? echo("No se puede Guardar Datos Repetidos(Seccion,Docente)...."."<br>"); }?>
  </p>
  </div>
</div>
</body>
