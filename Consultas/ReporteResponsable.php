...
<div id="menu">
    <ul>
       <li class="first"><a href="../Vista/FrmReportes.php" title="">Reportes</a></li>
    </ul>
</div>
<div id="content">
  <h1 align="center">&nbsp;</h1>
  <h1 align="left"><img src="../CSS/ico/Search.png" alt="" width="64" height="64" />Listar Responsables</h1>
  <div align="center">
<?
...
<? function btn($cont,$nombre,$grado){ ?>
        <form method="post" name="formu" action="ReporteResponsable1.php">
