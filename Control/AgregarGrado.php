...
<div id="content">
  <div align="center">
    ...
    $nivel=$_POST ['Nivel'];
    $grado=$_POST ['Grado'];
   // echo("nivel :$nivel ------- grado:$grado"."<br>");

   if ($_POST ['Nivel']==NULL || $_POST ['Grado']==NULL) {
       $logueado =2;
}else{
      $logueado=$a->agregar_grado($_POST ['Grado'],$_POST ['Nivel']);
}
?>
  <?if ($logueado ==2){?>
  ...
  <? echo("El Grado se Guardo con Exito....."."<br>"); }?>

  <?if ($logueado ==3){ ?>
    <p align="left"><img src="../CSS/ico/Edit_No.png" alt="" width="64" height="61"  />
  <? echo("Ya existe un Grado con ese Nombre...."."<br>"); }?>
  </p>
