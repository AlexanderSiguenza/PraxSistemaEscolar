...
<div id="menu">
    <ul>
        ...
        <li><a href="../Consultas/Coninstitucion2.php" title="">buscar</a></li>
...
<div id="content">
  <div align="center">
   ...
   if ($_POST ['nombre']==NULL || $_POST ['director']==NULL || $_POST ['telefono'] ==NULL || $_POST['direccion'] ==NULL || $_POST ['departamento'] ==NULL || $_POST ['municipio']  ==NULL || $_POST ['estado'] ==NULL || $_POST ['ano']==NULL){
      ...
      $a->agregar_institucion($_POST ['nombre'],$_POST ['director'],$_POST ['telefono'],$_POST['direccion'],                              $_POST ['departamento'],$_POST ['municipio'],$_POST ['estado'],$_POST ['ano']);
      $logueado =1;
}
?>
