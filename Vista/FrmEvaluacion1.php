...
<div id="content">
  <h1 align="left"><img src="../CSS/ico/Search.png" alt="" width="50" height="50" lowsrc="../CSS/ico/Search.png" />Elegir Grado</h1>
  <div align="center">
    <?
   ...
   // Mostrar resultados de la consulta
      ...
      if ($nfilas > 0)
      {
         ...
         for ($i=0; $i<$nfilas; $i++)
         {
            ...
            //echo ("$codigo");
            $codigoNivel = $resultado['codigoNivel'];
            $nombre= $resultado['Nombre'];
            $grado=  $resultado['usNombre'];
            btn($codigo,$nombre,$grado,$codigoNivel);
         }
         echo ("</TABLE>\n");
         echo "<ul> </ul>";
      }
...
<? function btn($cont,$nombre,$grado,$codigoNivel){ ?>
        <form method="post" name="formu" action="FrmEvaluacion.php">
         ...
         <input type="hidden" name="codigoNivel[]" value="<?php echo ("$codigoNivel")?>"">
         <? echo("");}?>
</div>
</form>
</body>
