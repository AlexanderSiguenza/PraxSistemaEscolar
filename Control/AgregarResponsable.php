...
<div id="content">
  <div align="center">
   ...
   if ($_POST ['Nombre']==NULL || $_POST ['Apellido1']==NULL || $_POST ['Sexo']==NULL  || $_POST ['Dui']==NULL || $_POST ['Parentesco']==NULL) {
      ...
      $a->agregar_responsable($_POST ['Nombre'],$_POST ['Apellido1'],$_POST ['Apellido2'],$_POST ['Direccion'],$_POST ['Departamento'],$_POST ['Departamento'],$_POST ['TelefonoC'],$_POST ['TelefonoT'],$_POST ['Sexo'],$_POST['Dui'],$_POST ['Parentesco']);
      $logueado =1;
}
?>
  ...
  <? echo("El Responsable del Alumno se Guardo con exito....."."<br>"); }?>
  </p>
  </div>
</div>
</body>
