...
<div id="content">
  <h1 align="left"><img src="../CSS/ico/Search.png" alt="" width="64" height="64" lowsrc="../CSS/ico/Search.png" />Consulta de Grados</h1>
  <div align="center">
    <?
...
<? function btn($cont){ ?>
        <form method="post" name="formu" action="Modgrado.php">
