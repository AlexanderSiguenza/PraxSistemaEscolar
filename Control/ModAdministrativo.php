...
<div id="content">
  ...
  if ($_POST ['nombres']==NULL || $_POST ['apellido1']==NULL || $_POST['fechanaci']==NULL || $_POST ['direccion']==NULL || $_POST ['departamento']==NULL || $_POST ['municipio']==NULL || $_POST ['sexo']==NULL || $_POST['dui']==NULL || $_POST ['Cargo']==NULL || $_POST ['usuario']==NULL || $_POST ['contrasena']==NULL) {
     $logueado =2;
      ...
      $municipio=1;
      $a->modificar_administrativo($_POST ['Codigo'],$_POST ['nombres'],$_POST ['apellido1'],$_POST ['apellido2'],$_POST['fechanaci'],$_POST ['direccion'],$_POST ['departamento'],$municipio,$_POST ['telefono'],$_POST ['sexo'],$_POST['dui'],$_POST ['Cargo'],$_POST ['usuario'] ,$_POST ['contrasena']);
      $logueado =1;
}
?>
  <?if ($logueado ==2){?>
  ...
  <? echo("El Administrativo se Modifico con exito....."."<br>"); }?>
  </p>
  </div>
</div>
</body>
